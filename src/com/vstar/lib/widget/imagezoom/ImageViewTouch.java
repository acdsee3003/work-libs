...
public class ImageViewTouch extends ImageViewTouchBase {
    ...
    public boolean canScroll(int direction) {
        ...
        //        L.i("================");
        //        L.i("bitmapRect.left->"+bitmapRect.left+" , bitmapRect.right->"+bitmapRect.right);
        //        L.i("imageViewRect.left->"+imageViewRect.left+" , imageViewRect.right->"+imageViewRect.right);
        //        L.i("mScrollRect.left->"+mScrollRect.left+" , mScrollRect.right->"+mScrollRect.right);
        //        L.i("================");
        //        L.i("bitmapRect.width->"+bitmapRect.width()+" , bitmapRect.height->"+bitmapRect.height());
        //        L.i("imageViewRect.width->"+imageViewRect.width()+" , imageViewRect.height->"+imageViewRect.height());
        //        L.i("mScrollRect.width->"+mScrollRect.width()+" , mScrollRect.height->"+mScrollRect.height());
        //        L.i("================");
        ...
        if (direction < 0) {
            return bitmapRect.right - imageViewRect.width() > SCROLL_DELTA_THRESHOLD;
        } else {
            return 0 - bitmapRect.left > SCROLL_DELTA_THRESHOLD;
        }
    }
