package com.vstar.lib.widget.waterfall;
 ...
 * <p/>
 * Users of this class should implement OnRefreshListener and call setOnRefreshListener(..) to get
 * notified on refresh events. The using class should call onRefreshComplete() when refreshing is
 * finished.
 * <p/>
 * The using class can call setRefreshing() to set the state explicitly to refreshing. This is
 * useful when you want to show the spinner and 'Refreshing' text when the refresh was not triggered
...
/**
 * 
 * <b>类名:</b> MultiColumnPullToRefreshListView.java</br>
 * <b>说明:</b> 可下拉刷新的瀑布流ListView</br>
 * <b>创建日期:</b> 2013-4-7下午2:21:30</br>
 * <b>更新时间:</b> 2013-4-7下午2:21:30</br>
...
public class MultiColumnPullToRefreshListView extends MultiColumnListView {
    ...
    private void init() {
        ...
        refreshingAnimation = new RotateAnimation(0, 720, RotateAnimation.RELATIVE_TO_SELF, 0.5f,
                                                  RotateAnimation.RELATIVE_TO_SELF, 0.5f);
    ...
    private void bounceBackHeader() {
        ...
        bounceAnimation = new TranslateAnimation(TranslateAnimation.ABSOLUTE, 0,
