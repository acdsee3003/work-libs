...
public abstract class ImageWorker {
    ...
    protected void loadImage(Object data, ImageView imageView) {
        loadImage(data, imageView, mLoadingBitmap, null);
    }

    protected void loadImage(Object data, ImageView imageView, OnImageFetcherListener listener) {
        loadImage(data, imageView, mLoadingBitmap, listener);
    }
    ...
    protected void loadImage(Object data, ImageView imageView, int resId,
        ...
        loadImage(data, imageView, loadingBitmaps.get(resId), listener);
    }
    ...
    public static boolean cancelPotentialWork(Object data, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (bitmapData == null || !bitmapData.equals(data)) {
                bitmapWorkerTask.cancel(true);
                L.d(TAG, "cancelPotentialWork - cancelled work for " + data);
            } else {
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        public BitmapWorkerTask(ImageView imageView, OnImageFetcherListener listener) {
        ...
        protected Bitmap doInBackground(Object... params) {
            L.d(TAG, "doInBackground - starting work");
            ...
            L.d(TAG, "doInBackground - finished work");
            return bitmap;
        }
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {
                L.d(TAG, "onPostExecute - setting bitmap");
